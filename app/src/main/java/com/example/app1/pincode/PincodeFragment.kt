package com.example.app1.pincode
...
import com.example.app1.databinding.FragmentPincodeBinding
...
class PincodeFragment : Fragment() {
    ...
    lateinit var centerRVAdapter: CenterRVAdapter1

    // creating a variable for our list
    lateinit var centerList: List<CenterRVModal1>
    ...
    override fun onCreateView(
        ...
        centerList = ArrayList<CenterRVModal1>()
        ...
        searchButton.setOnClickListener {
            ...
            if (pinCode.length != 6) {
                ...
                (centerList as ArrayList<CenterRVModal1>).clear()
            ...
            JsonObjectRequest(
                Request.Method.GET, url, null, { response ->
                    ...
                    try {
                        ...
                        centerRVAdapter = CenterRVAdapter1(centerList)
